...
//}
//
//int** unionV(int** G1, int** G2, int size1, int size2) {
...
//			Gtemp[i - sizemin][j - sizemax] = G1[i][j];
//		}
//	}
//
//	return Gtemp;
...
//	G3 = unionV(G1, G2, sizeG1, sizeG2);
//	printf("Obed:\n");
//	printG(G3, sizeG3);
//
//	sizeG3 = (sizeG1 < sizeG2) ? sizeG1 : sizeG2;
//	G3 = intersectG(G1, G2, sizeG1, sizeG2);
//	printf("Peresech:\n");
//	printG(G3, sizeG3);
//
//	sizeG3 = ((sizeG1 > sizeG2) ? sizeG1 : sizeG2) - ((sizeG1 < sizeG2) ? sizeG1 : sizeG2) + 1;
//	G3 = intersectG(G1, G2, sizeG1, sizeG2);
//	printf("Kolc summa:\n");
//	printG(G3, sizeG3);
//}